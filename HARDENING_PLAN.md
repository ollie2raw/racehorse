...
**Picking this up cold:** there is no "next system" to start — the numbered sequence is done. Decide among: (a) one of the four parked pools above, (b) building one of the five NOT-YET-BUILT guardrails (#2–#6), or (c) something outside this plan's original scope entirely. None of these carry the urgency the numbered systems did — treat this file as complete for its stated purpose (Systems 1–13 hardened) unless new live evidence says otherwise.
