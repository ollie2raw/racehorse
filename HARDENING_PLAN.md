...
- [x] Step 2 — invariants (§10.2, GM-INV-1..10) + risk-ranked gap list (§10.3, GM-1..GM-4) written 2026-09-05. Pre-Step-2 design question resolved: post-migration restart recovery needs no code fix (traced the full round trip), only the migration itself + a redeploy/restart (folded into GM-1). **Awaiting human ratification — Step 3 does not start until then.**
