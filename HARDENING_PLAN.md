...
| 8 — Ranking / Glicko-2 | Closed **for audited scope only** — RK-5 closed 2026-09-05 (shared `supabaseFetch`); RK-3/RK-6 ratified REVISIT IF SCALE, still untouched | D-15 |
...
- [ ] RK-3 / RK-6 — REVISIT IF SCALE, untouched
