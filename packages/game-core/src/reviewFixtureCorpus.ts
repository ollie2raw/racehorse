...
const FIXTURE_SPECS: readonly ReviewFixtureSpec[] = [
  {
    ...
    actionIndex: 0,
    expected: {
      preDigest: 'review-state-v1:320db2c4',
      postDigest: 'review-state-v1:840319d6',
  ...
  },
  {
    ...
    actionIndex: 1,
    expected: {
      preDigest: 'review-state-v1:840319d6',
      postDigest: 'review-state-v1:2da835cd',
  ...
  },
  {
    ...
    actionIndex: 2,
    expected: {
      preDigest: 'review-state-v1:2da835cd',
      postDigest: 'review-state-v1:5279d212',
  ...
  },
  {
    ...
    actionIndex: 6,
    expected: {
      preDigest: 'review-state-v1:f5fe7d9f',
      postDigest: 'review-state-v1:667a11f9',
  ...
  },
  {
    ...
    actionIndex: 13,
    expected: {
      preDigest: 'review-state-v1:7b807a94',
      postDigest: 'review-state-v1:c29cbfa8',
  ...
  },
  {
    ...
    actionIndex: 12,
    expected: {
      preDigest: 'review-state-v1:21a3e3c5',
      postDigest: 'review-state-v1:2fbf0a82',
  ...
  },
  {
    ...
    actionIndex: 26,
    expected: {
      preDigest: 'review-state-v1:ee15c800',
      postDigest: 'review-state-v1:8dcae003',
  ...
  },
  {
    ...
    actionIndex: 33,
    expected: {
      preDigest: 'review-state-v1:a34d9db9',
      postDigest: 'review-state-v1:3a7cfb68',
      action: { kind: 'pass' },
      immediatePoints: 0,
    },
  },
