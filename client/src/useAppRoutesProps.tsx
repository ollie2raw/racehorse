  ...
  const multiplayerModeViewProps = useMemo(
    (): MultiplayerModeViewProps => ({
      ...
      liveMatchView: {
        ...
        multiplayerMoveLog: source.multiplayerMoveLog,
        historyScrubberEnabled: source.historyScrubberEnabled,
        play: source.play,
    ...
    [
      ...
      source.multiplayerMoveLog,
      source.historyScrubberEnabled,
      source.play,
      source.myHand,
