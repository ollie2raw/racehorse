...
export const APPROVED_SOCKET_REGISTRAR_FILES = [
  ...
  'multiplayer/useSocialInviteState.ts',
  'multiplayer/useMultiplayerRoomCallbacks.ts',
...
export const SOCKET_EVENT_REGISTRY: readonly SocketEventRegistryEntry[] = [
  ...
  },
  {
    ...
    registrar: 'multiplayer/useMultiplayerRoomCallbacks.ts',
  ...
  },
  {
    ...
    registrar: 'multiplayer/useSocialInviteState.ts',
    additionalRegistrars: ['multiplayer/useFriendChallenge.ts'],
    boundedContext: 'social',
    registrationKind: 'raw',
    enforced: true,
    description: 'Friend challenge declined — social invite hook + challenge hook handlers',
  },
  {
