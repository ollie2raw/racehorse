...
export function buildHandLifecycleArgs(
  ...
  return {
    ...
    dailyFritzAuthorityRevision: sources.dailyFritz.dailyFritzAuthorityRevision,
    applyDailyFritzAuthorityCursor: sources.dailyFritz.applyDailyFritzAuthorityCursor,
