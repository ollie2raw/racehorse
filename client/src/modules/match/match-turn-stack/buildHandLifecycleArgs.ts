...
export function buildHandLifecycleArgs(
  ...
  return {
    ...
    dailyFritzHandIndex: sources.bootstrap.dailyFritzHandIndex,
    dailyFritzAuthorityRevision: sources.bootstrap.dailyFritzAuthorityRevision,
    applyDailyFritzNextHand: sources.bootstrap.applyDailyFritzNextHand,
